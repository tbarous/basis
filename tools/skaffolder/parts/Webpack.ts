...
class Webpack {
  ...
  addHtmlWebpackPlugin(): Webpack {
    this.plugins.push(
      `REMOVEnew HtmlWebpackPlugin({scriptLoading: 'blocking',inject: 'body',templateContent: '<div id="root"></div>',filename: 'index.html',publicPath: 'http://localhost:3000'})REMOVE`
    );
    return this;
  }
